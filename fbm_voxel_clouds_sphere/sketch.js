...
FBM / Ridged Noise Voxel Clouds (Sphere)

Same as fbm_voxel_clouds but with an additional spherical clipping
volume: voxels outside a sphere of radius GRID_SIZE/2 centered on
the grid are discarded, carving the cubic grid into a sphere before
the noise threshold is applied.
...
console.log( `Voxel cloud (sphere): ${ instanceCount } surface instances` );
